@include('partials.admin-navbar');
    ...
    <div class="container-fluid">
          ...
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Warning!</strong>  Ensure you upload image dimension that is the same or above the dimension specified Width:193px Height:262px
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                    <form action="{{ url('upload-avatar/'.$userId->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
