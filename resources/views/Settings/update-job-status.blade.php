@include('partials.admin-navbar');
    ...
    <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
            <h1 class="h3 mb-0 text-gray-800"> Update Occupation </h1>
          </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Update Occupation</h6>
                        </a>
                        <!-- Card Content - Collapse -->
                        <div class="collapse show" id="collapseCardExample5">
                        <div class="card-body">
                       <form action="{{ url('/settings/update/'.Auth::user()->id.'/job-information') }}" method="POST">
                        @csrf
                        <label>Update</label>
